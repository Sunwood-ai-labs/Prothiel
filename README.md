...
1. リポジトリをクローンします: `git clone https://github.com/Sunwood-ai-labs/Prothiel.git`
...
```bash
run: git push --force https://MakiAi:$HF_TOKEN@huggingface.co/spaces/MakiAi/Prothiel main
```
...
- v1.1.0 (2024-04-24):
  ...
  - プロジェクト名を「HarmonAI」から「Prothiel」に変更
- v1.0.0 (2024-04-20):
  - 初回リリース
  - 基本的な機能を実装
